...
const { postPetRequest, approveRequest, deletePost, allPets } = require('../Controllers/PetController');
...
router.post('/services',authMiddleware, upload.single('picture'), postPetRequest);
